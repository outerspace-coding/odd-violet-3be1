...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/odd-violet-3be1
```

A live public deployment of this template is available at [https://odd-violet-3be1.templates.workers.dev](https://odd-violet-3be1.templates.workers.dev)
